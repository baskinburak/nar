    ...
    */
    class Packet {
        ...
        public:
            ...
            void make_syn(unsigned int str_id, unsigned int seqnum);
            ...
            void make_data(unsigned int sqnm, unsigned int str_id, const std::string& payload, unsigned int payload_len);
            void make_data(unsigned int sqnm, unsigned int str_id, const char* payload, unsigned int payload_len);
