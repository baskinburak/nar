    ...
    namespace MessageTypes {
        namespace WaitChunkPull {
            ...
            class Request : public RequestHeader {
                ...
                public:
                    Request(unsigned short rport = 0,long long int sid = -1, long long int cid = -1, long long int csize = -1): RequestHeader(std::string("wait_chunk_pull_request")), rand_port(rport), stream_id(sid), chunk_id(cid), chunk_size(csize){}
