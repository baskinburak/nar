...
-- Table `nar`.`Averages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nar`.`Averages` (
  `machine_id` VARCHAR(150) NOT NULL,
  `a0` FLOAT NULL DEFAULT 0,
  `a1` FLOAT NULL DEFAULT 0,
  `a2` FLOAT NULL DEFAULT 0,
  `a3` FLOAT NULL DEFAULT 0,
  `a4` FLOAT NULL DEFAULT 0,
  `a5` FLOAT NULL DEFAULT 0,
  `a6` FLOAT NULL DEFAULT 0,
  `a7` FLOAT NULL DEFAULT 0,
  `a8` FLOAT NULL DEFAULT 0,
  `a9` FLOAT NULL DEFAULT 0,
  `a10` FLOAT NULL DEFAULT 0,
  `a11` FLOAT NULL DEFAULT 0,
  `a12` FLOAT NULL DEFAULT 0,
  `a13` FLOAT NULL DEFAULT 0,
  `a14` FLOAT NULL DEFAULT 0,
  `a15` FLOAT NULL DEFAULT 0,
  `a16` FLOAT NULL DEFAULT 0,
  `a17` FLOAT NULL DEFAULT 0,
  `a18` FLOAT NULL DEFAULT 0,
  `a19` FLOAT NULL DEFAULT 0,
  `a20` FLOAT NULL DEFAULT 0,
  `a21` FLOAT NULL DEFAULT 0,
  `a22` FLOAT NULL DEFAULT 0,
  `a23` FLOAT NULL DEFAULT 0,
  PRIMARY KEY (`machine_id`),
  CONSTRAINT `machine_idasd`
    FOREIGN KEY (`machine_id`)
    REFERENCES `nar`.`Machines` (`Machine_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
DELIMITER $$
USE `nar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `nar`.`Machines_AFTER_INSERT` AFTER INSERT ON `Machines` FOR EACH ROW
BEGIN
	INSERT INTO TimeTable SET machine_id = NEW.Machine_id;
    INSERT INTO Averages SET machine_id = NEW.Machine_id;
END$$
